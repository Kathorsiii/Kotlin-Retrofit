...
class DataAdpter(private var dataList: List<DataModel>, private val context: Context) : RecyclerView.Adapter<DataAdpter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.authorTextView.text = dataModel.author
        holder.summaryTextView.text = dataModel.summary
    }
    ...
    class ViewHolder(itemLayoutView: View) : RecyclerView.ViewHolder(itemLayoutView) {
        ...
        init {
            authorTextView = itemLayoutView.findViewById(R.id.author)
        }

        lateinit var summaryTextView: TextView
        init {
            summaryTextView = itemLayoutView.findViewById(R.id.summary)
        }
    }
}